...
const PRECACHE = ['/', '/manifest.json', '/favicon.svg', '/apple-touch-icon.png', '/icon-192.png', '/icon-512.png', '/rss.xml', '/atom.xml', '/cmdk-data.js', '/scripts/head-init.js', '/scripts/main.js', '/scripts/cmdk.js', '/scripts/theme.js', '/scripts/shared.js'];
