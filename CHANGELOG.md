...
- Added build-output public script minification. `build:ci` now minifies copied `dist/scripts/*.js` files after Astro build, trimming the current public script set from 91.0 KB to 67.6 KB while preserving readable source files.
