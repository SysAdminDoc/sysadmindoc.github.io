...
### Changed
- The preflight's browser accessibility audit was tried on a slowed-down PC, with every process start held back 5 seconds (the load that stopped the deploy runner's tests on 2026-09-23). All 106 checks passed in two minutes, well inside their limits, so the limits stay as they are.
