...
- The CSP report sink moves to the portfolio's private network. On the shared one, any of those twenty containers could post reports to it directly, and the nightly check planned for that store would have trusted them.
