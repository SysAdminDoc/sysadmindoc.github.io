...
- The critical CSS every page inlines is minified, 42.1 KB down to 34.8 KB, and the command palette's 62 KB project list loads when someone heads for the search button instead of on every page. The homepage HTML is 7.2 KB smaller. The bundle audit now budgets both the inline CSS and the palette data.
