...
export const interiorOgPages: InteriorOgPage[] = [
  ...
  },
  {
    ...
    route: '/resume/',
    title: 'Resume',
    description: 'Printable resume for Matt Parker, spanning enterprise IT, systems administration, healthcare imaging support, and customer-facing escalation work.',
    label: 'Career',
    accent: '#4ade80',
  ...
  },
  {
    ...
    route: '/healthcare-it/',
    title: 'Healthcare IT',
    description: 'Healthcare IT context for PACS/DICOM support, DR acquisition workstations, customer migrations, cloud imaging access, and support documentation.',
