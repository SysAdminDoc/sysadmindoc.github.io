...
export const now = {
  ...
  building: [
    `Portfolio site ${siteVersion}: ${fallbackRepoCount} repos on Astro 7 and a Contabo VPS. Every deploy now sends a test message through the contact form and waits for its notification`,
