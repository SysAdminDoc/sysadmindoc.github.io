...
export const catalog: CatalogEntry[] = [
  ...
  { repo: "SurfaceMedic", name: "SurfaceMedic", url: "https://github.com/SysAdminDoc/SurfaceMedic", category: "ps", desc: "Surface tune-up &amp; thermal toolkit &mdash; WPF GUI, thermal event scanner" },
  ...
  { repo: "AdapterLock", name: "AdapterLock", url: "https://github.com/SysAdminDoc/AdapterLock", category: "ps", desc: "Per-adapter IP lockdown &mdash; registry-ACL TCP/IP freeze, WPF GUI + headless CLI" },
  { repo: "LTSC-MicrosoftStore", name: "LTSC-MicrosoftStore", url: "https://github.com/SysAdminDoc/LTSC-MicrosoftStore", category: "ps", desc: "Add the Microsoft Store to Windows 11 24H2 LTSC" },
  { repo: "Brave-Portable-Updater", name: "Brave-Portable-Updater", url: "https://github.com/SysAdminDoc/Brave-Portable-Updater", category: "ps", desc: "Update Brave inside a Portapps portable install" },
  ...
  { repo: "AIUsageTracker", name: "AIUsageTracker", url: "https://github.com/SysAdminDoc/AIUsageTracker", category: "py", desc: "Windows dashboard tracking Claude &amp; Codex usage windows with reset alarms" },
  ...
  { repo: "ImgConverter", name: "ImgConverter", url: "https://github.com/SysAdminDoc/ImgConverter", category: "py", desc: "Universal image batch converter &mdash; 12+ input formats, 6 output formats, PyQt6 GUI + CLI" },
  { repo: "StormScope", name: "StormScope", url: "https://github.com/SysAdminDoc/StormScope", category: "py", desc: "Live US weather radar with 7,000+ webcam overlays" },
  ...
  { repo: "mnamer", name: "mnamer", url: "https://github.com/SysAdminDoc/mnamer", category: "py", desc: "Media file renaming &amp; organizing tool" },
  { repo: "TagStudio", name: "TagStudio", url: "https://github.com/SysAdminDoc/TagStudio", category: "py", desc: "User-focused photo &amp; file management system" },
  { repo: "FoxPort", name: "FoxPort", url: "https://github.com/SysAdminDoc/FoxPort", category: "py", desc: "Migrate passwords, bookmarks, and extensions from Chromium to Firefox" },
  ...
  { repo: "Cataclysm", name: "Cataclysm", url: "https://github.com/SysAdminDoc/Cataclysm", category: "web", desc: "3D-globe multi-hazard simulator &mdash; tsunamis, asteroid impacts, nuclear bursts, earthquakes with real physics" },
  ...
  { repo: "ForceBGTab", name: "ForceBGTab", url: "https://github.com/SysAdminDoc/ForceBGTab", category: "ext", desc: "Force link-opened tabs to the background &mdash; MV3, no page access" },
  ...
  { repo: "Vantage", name: "Vantage", url: "https://github.com/SysAdminDoc/Vantage", category: "ext", desc: "Chromium MV3 new-tab dashboard &mdash; customizable search, RSS, news, weather, quick links" },
  { repo: "AI-Usage_Tracker", name: "AI-Usage_Tracker", url: "https://github.com/SysAdminDoc/AI-Usage_Tracker", category: "ext", desc: "Countdown timer and notifications for Claude and Codex usage limits &mdash; Chrome, Firefox, and userscript builds" },
  { repo: "IMDb_Enhanced", name: "IMDb_Enhanced", url: "https://github.com/SysAdminDoc/IMDb_Enhanced", category: "ext", desc: "IMDb enhancement userscript" },
  ...
  { repo: "OpenLumen", name: "OpenLumen", url: "https://github.com/SysAdminDoc/OpenLumen", category: "kt", desc: "Open-source CF.Lumen successor &mdash; root-grade Android display color filter with rootless fallback" },
  ...
  { repo: "GuitarTuner", name: "GuitarTuner", url: "https://github.com/SysAdminDoc/GuitarTuner", category: "kt", desc: "Offline Android acoustic guitar tuner with automatic string detection" },
  { repo: "Droidsmith", name: "Droidsmith", url: "https://github.com/SysAdminDoc/Droidsmith", category: "kt", desc: "Cross-platform ADB GUI for managing Android devices" },
  ...
  { repo: "REDplusplus", name: "REDplusplus", url: "https://github.com/SysAdminDoc/REDplusplus", category: "cs", desc: "Remove Empty Directories utility &mdash; recursive cleanup with custom filter rules" },
  ...
  { repo: "RcloneBrowserNG", name: "RcloneBrowserNG", url: "https://github.com/SysAdminDoc/RcloneBrowserNG", category: "cpp", desc: "Modern rclone GUI &mdash; file browser, transfer manager, and mount handler in Qt/C++" },
  ...
  { repo: "QuotaGlass", name: "QuotaGlass", url: "https://github.com/SysAdminDoc/QuotaGlass", category: "cs", desc: "Always-visible Claude + Codex quota widget for Windows" },
  { repo: "TaskCopy", name: "TaskCopy", url: "https://github.com/SysAdminDoc/TaskCopy", category: "cs", desc: "Single-click clipboard snippet menu &mdash; tray icon, global hotkey, search" },
  { repo: "OpenNetLimit", name: "OpenNetLimit", url: "https://github.com/SysAdminDoc/OpenNetLimit", category: "cs", desc: "Per-application bandwidth limiter &amp; network monitor &mdash; open-source NetLimiter alternative" },
  { repo: "PartitionPilot", name: "PartitionPilot", url: "https://github.com/SysAdminDoc/PartitionPilot", category: "cs", desc: "Windows disk partition manager &mdash; WPF/.NET 10" },
  { repo: "AndroidEmulatorPlus", name: "AndroidEmulatorPlus", url: "https://github.com/SysAdminDoc/AndroidEmulatorPlus", category: "cs", desc: "Install Android SDK, manage AVDs, root with Magisk, migrate apps" },
  ...
  { repo: "Glossa", name: "Glossa", url: "https://github.com/SysAdminDoc/Glossa", category: "ext", desc: "On-device page translator, Bergamot in WebAssembly, no cloud" },
  { repo: "Aviary", name: "Aviary", url: "https://github.com/SysAdminDoc/Aviary", category: "ext", desc: "Download media from X and keep a searchable local post library" },
