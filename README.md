...
npm run smoke:live -- --base-url https://portfolio.getparkerai.com/ --expected-version 0.39.0 --expected-commit <commit-sha> --expected-projects 186 --expected-releases 60 --expected-feed-items 186
npm run smoke:release -- --tag v0.39.0 --asset sysadmindoc-portfolio-v0.39.0.zip --min-size 1000000
