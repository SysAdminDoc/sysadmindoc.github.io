...
![Version](https://img.shields.io/badge/version-0.21.25-blue)
...
npm run smoke:live -- --base-url https://sysadmindoc.github.io/ --expected-version 0.21.25 --expected-commit <commit-sha> --expected-projects 186 --expected-releases 60 --expected-feed-items 186
