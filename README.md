...
npm run smoke:live -- --base-url https://portfolio.getparkerai.com/ --expected-version 0.42.3 --expected-commit <commit-sha> --expected-projects 204 --expected-releases 60 --expected-feed-items 204
