...
![Version](https://img.shields.io/badge/version-0.21.15-blue)
...
npm run smoke:live -- --base-url https://sysadmindoc.github.io/ --expected-version 0.21.15 --expected-commit <commit-sha> --expected-projects 186 --expected-releases 9 --expected-feed-items 186
