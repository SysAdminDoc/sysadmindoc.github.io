...
- **Content collections**: featured (9), live apps (22), catalog (198 feed-backed / 201 local fallback), skills (8)
...
npm run smoke:live -- --base-url https://portfolio.getparkerai.com/ --expected-version 0.42.2 --expected-commit <commit-sha> --expected-projects 201 --expected-releases 60 --expected-feed-items 201
npm run smoke:release -- --tag v0.42.2 --asset sysadmindoc-portfolio-v0.42.2.zip --min-size 1000000
