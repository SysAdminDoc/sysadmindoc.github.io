...
npm run smoke:live -- --base-url https://sysadmindoc.github.io/ --expected-version 0.25.2 --expected-commit <commit-sha> --expected-projects 186 --expected-releases 60 --expected-feed-items 186
npm run smoke:release -- --tag v0.25.2 --asset sysadmindoc-portfolio-v0.25.2.zip --min-size 1000000
