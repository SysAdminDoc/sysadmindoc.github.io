...
npm run smoke:live -- --base-url https://sysadmindoc.github.io/ --expected-version 0.21.2 --expected-commit <commit-sha> --expected-projects 182 --expected-releases 9 --expected-feed-items 182
