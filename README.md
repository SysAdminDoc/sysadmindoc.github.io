...
- **Content collections**: featured (9), live apps (22), catalog (198 feed-backed / 202 local fallback), skills (8)
...
npm run smoke:live -- --base-url https://portfolio.getparkerai.com/ --expected-version 0.42.3 --expected-commit <commit-sha> --expected-projects 202 --expected-releases 60 --expected-feed-items 202
npm run smoke:release -- --tag v0.42.3 --asset sysadmindoc-portfolio-v0.42.3.zip --min-size 1000000
