// Stops the preview daemon that preview-server.mjs started. A run against an
// outside server (scripts/lib/audit-server.mjs) leaves no marker, so its server is left alone, and
