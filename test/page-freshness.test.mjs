...
const expectedSchemaSlugs = ['uses', 'resume', 'search', 'timeline', 'status', 'screenshots', 'archive', 'now', 'healthcare-it', 'ai', 'releases', 'catalog', 'data', 'colophon', 'privacy'];
const expectedVisibleSlugs = ['uses', 'resume', 'healthcare-it', 'ai', 'colophon'];
